...
import { pmInput } from "../../schemas/pminput";
...
export const registerRouteHandler = async (req, res, empid, name, email, password) => {
...
export const userInputRouteHandler = async (req, res, empid, name, email, department, status, team, shift, manager, location, date) => {
  // check if user already exists
  // let foundUser = await userModel.findOne({ email: email });
  // if (foundUser) {
  //   // does not get the error
...
export const pmInputRouteHandler = async (req, res, addproject) => {
  // check if user already exists
  // let foundUser = await userModel.findOne({ email: email });
  // if (foundUser) {
  //   // does not get the error
